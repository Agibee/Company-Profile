...
<div class="header-carousel owl-carousel">
    <div class="header-carousel-item">
        <img src="image/aku_dan_cerita_bersama_STIFIn-rcjuo7hg0sc7j3cbb72v21p58bj01asmldmykv1z74.webp"
                ...
                <div class="row justify-content-left">
                    <div class="col-xl-8 col-lg-10 col-md-11">
                        <div class="text-center text-md-start">
                            <h4 class="text-success text-uppercase fw-bold mb-3">Welcome To</h4>
                            <h1 class="display-5 fw-bold text-white mb-4">
                                STIFIn Personality Genetic Intelligence
                            </h1>
                            <p class="text-white-50 mb-4 fs-5" style="text-align: justify; line-height: 1.6;">
                                Lebih dari 600.000 orang dari 38 provinsi di Indonesia, serta beberapa negara di dunia,
                                telah mempercayakan Tes STIFIn untuk mengetahui karakter dan potensi diri. Tes ini sangat
                                membantu dalam menentukan jenjang karir, membangun bisnis atau investasi, melakukan
                                rekrutmen karyawan, serta memperlancar komunikasi dengan pasangan, keluarga, dan rekan bisnis.
                            </p>

                            <div class="d-flex justify-content-center justify-content-md-start mb-4">
                                <a class="btn btn-success rounded-pill py-3 px-4 px-md-5" href="?page=stifin/index">Explore More</a>
                            </div>

                            <div class="d-flex align-items-center justify-content-center justify-content-md-start">
                                <h5 class="text-white mb-0 me-3">Follow Us:</h5>
                                <div class="d-flex">
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
                <div>
                    <h1 class="text-primary display-5 mb-4">About Us</h1>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="d-flex">
                                <div><i class="fas fa-briefcase fa-3x text-primary"></i>
                                </div>
                                <div class="ms-4">
                                    <h4>Career & Education Guidance</h4>
                                    <p>Memberikan panduan karier dan pendidikan yang sesuai dengan mesin kecerdasan dan personaliti genetik, agar setiap langkah lebih efektif dan terarah.</p>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="d-flex">
                                <div><i class="fas fa-user-graduate fa-3x text-primary"></i>
                                </div>
                                <div class="ms-4">
                                    <h4>Personal Development</h4>
                                    <p>Membantu individu memahami potensi diri dan kecerdasan dominan melalui Tes STIFIn, sehingga dapat memaksimalkan bakat dan kariernya.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <a href="?page=stifin/index" class="btn btn-primary rounded-pill py-3 px-5 flex-shrink-0">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                <div class="bg-primary rounded position-relative overflow-hidden p-3">
                    <img src="image/mesinkecerdasan.jpg" class="img-fluid rounded w-100" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div style="background-color: #e6f9e6; border-radius: 15px;">
    <div class="row justify-content-center">
        <div class="col-xl-7 wow fadeInLeft" data-wow-delay="0.2s">
            <div class="text-center py-4">
                <h1 class="text-primary display-5 mb-4">Sebenarnya Apa Itu Konsep STIFIn</h1>
                <p>Anda akan mengenal lebih dekat Konsep STIFIn setelah menonton video ini</p>
                <div class="ratio ratio-16x9 mx-auto" style="max-width: 800px;">
                    <iframe src="https://www.youtube.com/embed/5nsR8SkYdv0"
...
<div class="container-fluid feature pb-5">
    <div class="container pb-5">
        ...
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            <h1 class="display-5 mb-4 text-primary">Keunggulan STIFIn</h1>
            <p class="mb-0">Apa yang membuat STIFIn berbeda?</p>
        </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="feature-item p-4 text-center">
                    ...
                    <h4>SIMPLE</h4>
                    <p class="mb-4">Konsep STIFIn terbagi menjadi 5 Mesin Kecerdasan dan 9 Personaliti Genetik. FOKUS-SATU-HEBAT</p>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                <div class="feature-item p-4 text-center">
                    ...
                    <h4>AKURAT</h4>
                    <p class="mb-4">Konsep STIFIn mengidentifikasi sistem operasi otak manusia. Validitas & reliabilitas 95%. 1X SEUMUR HIDUP</p>
                    <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="feature-item p-4 text-center">
                    ...
                    <h4>APLIKATIF</h4>
                    <p class="mb-4">Bersifat berkolerasi dengan berbagai aspek kehidupan atau MULTI-ANGLE-FIELD.</p>
                    <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a>
                </div>
            </div>
        </div>
...
<section class="stats-section py-5">
    ...
    $totalTes = $koneksi->query("SELECT COUNT(*) as total FROM clients")->fetch_assoc()['total'];
    ?>


    <div style="background-color:#20c997; border-radius:15px; padding:50px 0;">
        <div class="row text-center text-white justify-content-center">
            <!-- Item 1 -->
            <div class="col-md-3 mb-4 mb-md-0">
                <i class="fas fa-sitemap fa-3x mb-3"></i>
                <h2 class="fw-bold count" data-target="<?= $cabang ?>"></h2>
                <div class="underline mx-auto mb-2"></div>
                <p class="fw-bold text-uppercase">Cabang</p>
            </div>

            <!-- Item 2 -->
            <div class="col-md-3 mb-4 mb-md-0">
                <i class="fas fa-users fa-3x mb-3"></i>
                <h2 class="fw-bold count" data-target="<?= $promotor ?>"></h2>
                <div class="underline mx-auto mb-2"></div>
                <p class="fw-bold text-uppercase">Promotor</p>
            </div>

            <!-- Item 3 -->
            <div class="col-md-3">
                <i class="fas fa-puzzle-piece fa-3x mb-3"></i>
                <h2 class="fw-bold count" data-target="<?= $totalTes ?>"></h2>
                <div class="underline mx-auto mb-2"></div>
                <p class="fw-bold text-uppercase">Total Tes</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        <h3 class="text-center text-primary fw-bold">Statistik</h3>
                ...
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-striped text-center align-middle mb-0">
                            ...
                            <tbody>
                                <?php
                                $topPromotor = $koneksi->query("
                                    SELECT p.nama_promotor, COUNT(cl.id_client) AS total
                                    FROM clients cl
                                    JOIN promotor p ON cl.id_promotor = p.id_promotor
                                    WHERE YEAR(cl.tanggal_tes) = 2025
                                    GROUP BY p.id_promotor
                                    ORDER BY total DESC
                                    LIMIT 10
                                ");
                                while ($row = $topPromotor->fetch_assoc()):
                                ?>
                                    <tr>
                                        <td><?= htmlspecialchars($row['nama_promotor']) ?></td>
                                        <td><?= number_format($row['total']) ?></td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
                    ...
                    <div class="card-body p-0">
                        <table class="table table-striped text-center align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                $bulanIni = date('m');
                                $tahunIni = date('Y');
                                $cabangBulanIni = $koneksi->query("
                                    SELECT c.nama_cabang, COUNT(cl.id_client) AS total
                                    FROM clients cl
                                    JOIN cabang c ON cl.id_cabang = c.id_cabang
                                    WHERE MONTH(cl.tanggal_tes) = '$bulanIni'
                                    AND YEAR(cl.tanggal_tes) = '$tahunIni'
                                    GROUP BY c.id_cabang
                                    ORDER BY total DESC
                                    LIMIT 3
                                ");
                                while ($row = $cabangBulanIni->fetch_assoc()):
                                ?>
                                    <tr>
                                        <td><?= htmlspecialchars($row['nama_cabang']) ?></td>
                                        <td><?= number_format($row['total']) ?></td>
                ...
                <div class="card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-striped text-center align-middle mb-0">
                            ...
                            <tbody>
                                <?php
                                $promotorBulanIni = $koneksi->query("
                                    SELECT p.nama_promotor, COUNT(cl.id_client) AS total
                                    FROM clients cl
                                    JOIN promotor p ON cl.id_promotor = p.id_promotor
                                    WHERE MONTH(cl.tanggal_tes) = '$bulanIni'
                                    ...
                                    LIMIT 3
                                ");
                                while ($row = $promotorBulanIni->fetch_assoc()):
                                ?>
                                    <tr>
                                        <td><?= htmlspecialchars($row['nama_promotor']) ?></td>
                                        <td><?= number_format($row['total']) ?></td>
...
<!-- Post Start -->
<div class="container-fluid service pb-5" style="background-color: #e6f9e6; padding:30px;">
    <div class="container pb-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            <h4 class="text-primary">Recent Post</h4>
            <h1 class="display-5 mb-4">Dapatkan Informasi dari STIFIn</h1>
            <p class="mb-0">
                Temukan berbagai artikel, tips, dan informasi menarik seputar konsep STIFIn yang dapat membantu memahami potensi diri Anda.
            </p>
        </div>
        ...
        <div class="row g-4">
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM artikel ORDER BY tanggal_upload DESC LIMIT 6");

            if (mysqli_num_rows($query) > 0) {
                while ($data = mysqli_fetch_assoc($query)) {
                    $id = intval($data['id_artikel']);
                    $judul = htmlspecialchars($data['judul']);
                    $deskripsi = substr(strip_tags($data['isi']), 0, 120) . '...';

                    // Path gambar artikel
                    $gambar_path = "admin/assets/img/artikel/" . $data['gambar'];
                    $gambar = (!empty($data['gambar']) && file_exists($gambar_path))
                        ? $gambar_path
                        : "assets/img/noimage.png";
            ?>
                    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-item shadow-sm rounded-4 overflow-hidden border-0">
                            ...
                            <div class="rounded-bottom p-4 bg-white">
                                <a href="index.php?page=artikel/detail&id="
                                    class="h5 text-dark fw-bold d-inline-block mb-2 text-decoration-none">
                                    <?= $judul ?>
                                </a>
                                <p class="text-muted mb-3"><?= $deskripsi ?></p>
                                <a href="index.php?page=artikel/detail&id=<?= $id ?>"
            ...
            <?php
                ...
                echo "<div class='col-12 text-center'><p class='text-muted'>Belum ada artikel tersedia.</p></div>";
            }
            ?>
        </div>
    </div>
...
<section class="bg-light py-5 text-center">
    <div class="container px-5">
        <h5 class="text-primary mb-3">Meet Our Happy Clients</h5>
        <div class="row justify-content-center align-items-center g-4">

            <?php
            $query = "SELECT logo FROM kerjasama";
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-6 col-md-2 col-lg-2">
                        <img src="admin/assets/img/kerjasama/' . htmlspecialchars($row['logo']) . '" 
                             alt="Client Logo" 
                             class="img-fluid" 
