    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <a href="?page=cabang/tambah" class="btn btn-primary">
                ...
                <table id="dataTable" class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $sql = mysqli_query($koneksi, "
                            ...
                            FROM cabang 
                            LEFT JOIN kota ON cabang.id_kota = kota.id_kota
                            ORDER BY nama_cabang ASC
                        ");
                        while ($cabang = mysqli_fetch_array($sql)) {
                        ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                <td><?= htmlspecialchars($cabang['nama_cabang']); ?></td>
                                <td><?= htmlspecialchars($cabang['nama_kota']); ?></td>
                                <td><?= htmlspecialchars($cabang['jam_buka']); ?></td>
                                <td><?= htmlspecialchars($cabang['jam_tutup']); ?></td>
                                <td><?= htmlspecialchars($cabang['status']); ?></td>
                                <td>
